...
export const Route = createFileRoute("/_app/crm/cash")({
 ...
 *
 * The route is `/crm/cash`. `/telesales` is where this lived and still answers,
 * as a redirect — see `_app.telesales.index.tsx`.
 */
